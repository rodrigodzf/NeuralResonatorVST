...
public:
    TwoPoleInterpolated()
        : m_interpolator(N_COEFFICIENTS_TWO_POLE, 0){};
    ~TwoPoleInterpolated();
...
inline void TwoPoleInterpolated::setCoefficientValues(
    double b0,
    double b1,
    double b2,
    double a1,
...
inline void TwoPoleInterpolated::setCoefficientTargets(
    double b0,
    double b1,
    double b2,
    double a1,
...
{
    JLOG("TwoPoleInterpolated::cleanup()");
    m_interpolator.cleanup();
}

inline void TwoPoleInterpolated::set_coefficients(
    double b0,
    double b1,
    double b2,
    double a1,
