...
// https://codesandbox.io/s/3k4g6?file=/src/App.js
    ...
    <context.Provider value={set}>
      <group ref={group}>
        {lines.map((line, index) => (
          <group>
            <Line key={line.uniqueId} {...line} color="white" dashed dashScale={50} gapSize={20} />
            <Line key={line.uniqueId} {...line} color="white" lineWidth={2} transparent opacity={0.1} />
          </group>
        ))}
      </group>
      {children}
