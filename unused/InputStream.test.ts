...
describe('readString', () => {
	test('read multiple strings', () => {
		...
		const stream = new InputStream(
			encoder.encode('1test1' + String.fromCharCode(0) + '2test2' + String.fromCharCode(0)),
		)
...
describe('readVar', () => {
	test('int', () => {
		const stream = new InputStream(Uint8Array.from([0x01, 0x05, 0x01, 0xd2, 0x04, 0x00, 0x00]))
