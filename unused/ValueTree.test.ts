...
describe('readFromStream', () => {
	test('read tree successfully', () => {
		...
		expect(tree.properties.get('int64Property')!.toString()).toEqual('9223372036854775800')
		...
		expect(tree.children[0].properties.get('stringProperty')).toEqual('TestChildProperty')
		...
		expect(tree.children[0].children[0].properties.get('stringProperty')).toEqual(
